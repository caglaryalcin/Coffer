...
const tr: TranslationDictionary = {
  ...
  "Coffer could not update account creation. Please try again.": "Coffer hesap oluşturma ayarını güncelleyemedi. Lütfen tekrar dene.",
  ...
  "Create a complete backup containing accounts, website URLs, groups, favorites, custom logos, and TOTP settings. Add a passphrase for protection, or leave both fields blank.": "Hesapları, web sitesi URL'lerini, grupları, favorileri, özel logoları ve TOTP ayarlarını içeren eksiksiz bir yedek oluştur. Koruma için parola ekle veya iki alanı da boş bırak.",
  ...
  "Enter a valid Base32 secret before testing.": "Test etmeden önce geçerli bir Base32 sırrı gir.",
  ...
  "Keep the Create account tab available and allow new users to register on this instance.": "Create account sekmesini açık tutar ve bu instance'a yeni kullanıcıların kaydolmasına izin verir.",
  ...
  "Account creation disabled.": "Hesap oluşturma kapatıldı.",
  "Account creation enabled.": "Hesap oluşturma açıldı.",
  "Account creation is disabled for this Coffer instance.": "Bu Coffer instance'ında hesap oluşturma kapalı.",
  ...
  "All Cards is now the default main screen.": "Tüm Kartlar artık varsayılan ana ekran.",
  "All Cards options": "Tüm Kartlar seçenekleri",
  "Open All Cards options": "Tüm Kartlar seçeneklerini aç",
  "All visible selected": "Görünenlerin tümü seçildi",
  "Allow new account registration": "Yeni hesap kaydına izin ver",
  "Apply": "Uygula",
  ...
  "Back to All Cards": "Tüm Kartlar'a dön",
  ...
  "Get the Firefox extension": "Firefox eklentisini al",
  "Get the Firefox extension in a new tab": "Firefox eklentisini yeni sekmede aç",
  "Go back": "Geri dön",
  ...
  "Website URLs": "Web sitesi URL'leri",
  "About website URLs": "Web sitesi URL'leri hakkında",
  "Only required if you use the Coffer extension.": "Yalnızca Coffer extension kullanıyorsanız gereklidir.",
  "+ Add another URL": "+ Başka URL ekle",
  "Add URLs": "URL ekle",
  "Add URLs to selected accounts": "Seçili hesaplara URL ekle",
  "Add at least one website URL.": "En az bir web sitesi URL'si ekleyin.",
  "Add one URL per line, up to 32. Only required if you use the Coffer extension.": "Her satıra bir URL ekleyin; en fazla 32 URL. Yalnızca Coffer extension kullanıyorsanız gereklidir.",
  "Used by the Coffer extension to match this account for autofill.": "Coffer eklentisinin otomatik doldurma için bu hesabı eşleştirmesinde kullanılır.",
  "Optional. Used by the Coffer extension to match this account for autofill.": "İsteğe bağlıdır. Coffer eklentisinin otomatik doldurma için bu hesabı eşleştirmesinde kullanılır.",
...
const de: TranslationDictionary = {
  ...
  "Coffer could not update account creation. Please try again.": "Coffer konnte die Kontoerstellung nicht aktualisieren. Bitte versuche es erneut.",
  ...
  "Create a complete backup containing accounts, website URLs, groups, favorites, custom logos, and TOTP settings. Add a passphrase for protection, or leave both fields blank.": "Erstelle ein vollständiges Backup mit Konten, Website-URLs, Gruppen, Favoriten, eigenen Logos und TOTP-Einstellungen. Füge zum Schutz eine Passphrase hinzu oder lasse beide Felder leer.",
  ...
  "Enter a valid Base32 secret before testing.": "Gib vor dem Testen ein gültiges Base32-Geheimnis ein.",
  ...
  "Keep the Create account tab available and allow new users to register on this instance.": "Lässt den Tab Konto erstellen verfügbar und erlaubt neuen Benutzern, sich auf dieser Instanz zu registrieren.",
  ...
  "Account creation disabled.": "Kontoerstellung deaktiviert.",
  "Account creation enabled.": "Kontoerstellung aktiviert.",
  "Account creation is disabled for this Coffer instance.": "Die Kontoerstellung ist für diese Coffer-Instanz deaktiviert.",
  ...
  "All Cards is now the default main screen.": "„Alle Karten“ ist jetzt der Standard-Startbildschirm.",
  "All Cards options": "Optionen für alle Karten",
  "Open All Cards options": "Optionen für alle Karten öffnen",
  "All visible selected": "Alle sichtbaren ausgewählt",
  "Allow new account registration": "Neue Kontoregistrierung erlauben",
  "Apply": "Anwenden",
  ...
  "Back to All Cards": "Zurück zu allen Karten",
  ...
  "Get the Firefox extension": "Firefox-Erweiterung installieren",
  "Get the Firefox extension in a new tab": "Firefox-Erweiterung in einem neuen Tab öffnen",
  "Go back": "Zurück",
  ...
  "About website URLs": "Über Website-URLs",
  "Only required if you use the Coffer extension.": "Nur erforderlich, wenn du die Coffer-Erweiterung verwendest.",
  "+ Add another URL": "+ Weitere URL hinzufügen",
  "Add URLs": "URLs hinzufügen",
  "Add URLs to selected accounts": "URLs zu ausgewählten Konten hinzufügen",
  "Add at least one website URL.": "Füge mindestens eine Website-URL hinzu.",
  "Add one URL per line, up to 32. Only required if you use the Coffer extension.": "Füge eine URL pro Zeile hinzu, höchstens 32. Nur erforderlich, wenn du die Coffer-Erweiterung verwendest.",
  "Used by the Coffer extension to match this account for autofill.": "Wird von der Coffer-Erweiterung verwendet, um dieses Konto beim automatischen Ausfüllen zuzuordnen.",
  "Optional. Used by the Coffer extension to match this account for autofill.": "Optional. Wird von der Coffer-Erweiterung verwendet, um dieses Konto beim automatischen Ausfüllen zuzuordnen.",
...
const trPatterns: TranslationPattern[] = [
  ...
  { pattern: /^Add to (\d+)$/u, replace: (count) => `${count} hesaba ekle` },
  { pattern: /^Website URL (\d+)$/u, replace: (count) => `Web sitesi URL'si ${count}` },
  { pattern: /^Remove website URL (\d+)$/u, replace: (count) => `${count}. web sitesi URL'sini kaldır` },
  { pattern: /^Existing URLs are kept for all (\d+) selected accounts?\.$/u, replace: (count) => `${count} seçili hesabın mevcut URL'leri korunur.` },
  ...
  { pattern: /^Draft code (.+)$/u, replace: (code) => `Taslak kod ${code}` },
  ...
  { pattern: /^(.+) restored to All Cards\.$/u, replace: (name) => `${name}, Tüm Kartlar'a geri yüklendi.` },
...
const dePatterns: TranslationPattern[] = [
  ...
  { pattern: /^Add to (\d+)$/u, replace: (count) => `Zu ${count} hinzufügen` },
  { pattern: /^Website URL (\d+)$/u, replace: (count) => `Website-URL ${count}` },
  { pattern: /^Remove website URL (\d+)$/u, replace: (count) => `Website-URL ${count} entfernen` },
  { pattern: /^Existing URLs are kept for all (\d+) selected accounts?\.$/u, replace: (count) => `Vorhandene URLs bleiben für alle ${count} ausgewählten Konten erhalten.` },
  ...
  { pattern: /^Draft code (.+)$/u, replace: (code) => `Entwurfscode ${code}` },
  ...
  { pattern: /^(.+) restored to All Cards\.$/u, replace: (name) => `${name} wurde in „Alle Karten“ wiederhergestellt.` },
